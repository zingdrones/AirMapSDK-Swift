...
extension Reactive where Base: AirMap {
	...
	public static func getFlightPlanAuthorizations(_ flightPlanId: AirMapFlightPlanId) -> Observable<[AirMapAuthorization]> {
		return AirMap.flightPlanClient.getAuthorizations(flightPlanId)
	}
