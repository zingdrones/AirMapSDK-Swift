...
public extension Airmap.Telemetry {
    ...
    final public class Position : GeneratedMessage {
        ...
        override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Airmap.Telemetry.Position {
            return try Airmap.Telemetry.Position.Builder.fromJSONToBuilder(data:data, options:options).build()
        }
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Airmap.Telemetry.Position.Builder {
    ...
    final public class Attitude : GeneratedMessage {
        ...
        override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Airmap.Telemetry.Attitude {
            return try Airmap.Telemetry.Attitude.Builder.fromJSONToBuilder(data:data, options:options).build()
        }
        override public func getDescription(indent:String) throws -> String {
            var output = ""
            if hasTimestamp {
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Airmap.Telemetry.Attitude.Builder {
                let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
                guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
                  throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
                }
    ...
    final public class Speed : GeneratedMessage {
        ...
        override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Airmap.Telemetry.Speed {
            return try Airmap.Telemetry.Speed.Builder.fromJSONToBuilder(data:data, options:options).build()
        }
        override public func getDescription(indent:String) throws -> String {
            var output = ""
            if hasTimestamp {
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Airmap.Telemetry.Speed.Builder {
                let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
                guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
                  throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
                }
    ...
    final public class Barometer : GeneratedMessage {
        ...
        override class public func fromJSON(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Airmap.Telemetry.Barometer {
            return try Airmap.Telemetry.Barometer.Builder.fromJSONToBuilder(data:data, options:options).build()
        }
        override public func getDescription(indent:String) throws -> String {
            var output = ""
            if hasTimestamp {
        ...
        final public class Builder : GeneratedMessageBuilder {
            ...
            override class public func fromJSONToBuilder(data:Data, options: JSONSerialization.ReadingOptions = []) throws -> Airmap.Telemetry.Barometer.Builder {
                let jsonData = try JSONSerialization.jsonObject(with:data, options: options)
                guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
                  throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
                }
