...
public struct System_Status {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var level: System_Status.Level = .unknown
...
extension System_Status.Level: CaseIterable {
  ...
  public static var allCases: [System_Status.Level] = [
    .unknown,
    .normal,
    .maintenance,
    .degraded,
...
extension System_Status: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: System_Status, rhs: System_Status) -> Bool {
